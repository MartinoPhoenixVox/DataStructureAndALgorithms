...
void RandomArray(int a[], int &n) {
	...
	for (int i = 0; i < n; i++) //khoi tao mang co n phan tu
		a[i] = rand() % 10000; //mang co gia tri ngau nhien tu 1 toi 9999
...
int main()
{
    ...
    const int maxOpt = 10; //gia tri lua choin toi da co the co
	clock_t start;
	double duration;
    ...
    do {
        ...
        cout << "-----MENU-----\n"
            ...
            << "3. Xuat danh sach\n"
			<< "4. HeapSort danh sach\n"
			<< "5. HeapSort2 danh sach\n"
