...
int main()
{
    ...
    const int maxOpt = 12; //gia tri lua choin toi da co the co
	clock_t start;
	double duration;
    ...
    do {
		...
		cout << "-----MENU-----\n"
			...
			<< "3. Xuat danh sach\n"
			<< "4. QuickSort danh sach\n"
			<< "5. QuickSort2 danh sach\n"
			<< "6. InsertionSort danh sach\n"
			<< "7. SelectionSort danh sach\n"
			<< "8. BubbleSort danh sach\n"
			<< "9. InterchangeSort danh sach\n"
			<< "10. MergeSort danh sach\n"
			<< "11. HeapSort danh sach\n"
			<< "12. HeapSort2 danh sach\n";
		...
		case 7:
			cout << "7. SelectionSort danh sach\n";
			CopyArray(Array, Temp, n);
			start = clock();
		...
		case 9:
			cout << "9. InterchangeSort danh sach\n";
			CopyArray(Array, Temp, n);
			start = clock();
